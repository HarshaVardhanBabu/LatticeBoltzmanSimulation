...
#define time_step 5000 //write up
#define time 50000
...
void collision(){	
	...
	for(k=0;k<=np;k++){
		for(i=0;i<=nx+1;i++){
			for(j=0;j<=ny+1;j++){
		fn[k][i][j]=f[k][i][j]*(1-1/tau)+(1/tau)*feq[k][i][j] + g*rho[i][j]*grav[k]*delt;
			}
		}
	}
}	
...
main()
{
	...
	char *file_nameue[]={"eut0.dat","eut100.dat","eut200.dat","eut300.dat","eut400.dat","eut500.dat","eut600.dat","eut700.dat","eut800.dat","eut900.dat","eut100.dat"};
	char *file_nameum[]={"mut0.dat","mut100.dat","mut200.dat","mut300.dat","mut400.dat","mut500.dat","mut600.dat","mut700.dat","mut800.dat","mut900.dat","mut100.dat"};
	char *file_nameus[]={"sut0.dat","sut100.dat","sut200.dat","sut300.dat","sut400.dat","sut500.dat","sut600.dat","sut700.dat","sut800.dat","sut900.dat","sut100.dat"};
	...
	char *gnuplot[] = {"t0.plt","t100.plt","t200.plt","t300.plt","t400.plt","t500.plt","t600.plt","t700.plt","t800.plt","t900.plt","t1000.plt"};
